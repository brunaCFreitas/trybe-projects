...
Neste projeto foi implementado um editor de arte com pixels onde a pessoa usuária pode escolher uma cor em uma paleta de cores que é gerada aleatóriamente a cada clique no botão `cores aleatorias`. Além disso, poderá ser escolhido um tamanho de quadro que varia de 5 a 50, sendo sua dimensão n X n.
